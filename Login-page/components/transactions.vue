<template>
    <div class="bg-white pt-16 md:pt-0">
      ...
      <tr v-for="action in actions" :key="action.sn">
        <td>{{action.sn}}</td>
        <td>{{action.date}}</td>
        <td class="min-w-[180px]">{{action.name}}</td>
        <td>{{action.title}}</td>
        <td>{{action.ticket}}</td>
        <td>{{action.price}}</td>
        <td v-html="action.status"></td>
        <td>{{action.license}}</td>
        <td v-html="action.tag"></td>
        <td>
